...
function lakukanLooping(arrPegawai) {
  ...
  */
  ...
  for(let ip = 0; ip < dataYangAkanDilooping.length; ip++) {
    if(dataYangAkanDilooping[ip].jenisKelamin == 'M') {
      jumlahPria++
    }
  };
  ...
  */
  ...
  for(let iw = 0; iw < dataYangAkanDilooping.length; iw++) {
    if(dataYangAkanDilooping[iw].jenisKelamin == 'F') {
      jumlahWanita++
    }
  };
